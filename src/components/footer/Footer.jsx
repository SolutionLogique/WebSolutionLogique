        ...
        <footer className="footer">
            <div className="container">
                <div className="footer_description">
                    ...
                    <Link to="/factureElectronique"><li>Facture électronique</li> </Link>
                ...
                <div className="copyright_sli">
                    <Link to="/conditionsGeneralesVente">
                        <p className="copyright_sli_bot">Conditions générales de Vente</p>
                    </Link>
                </div>
                <div className="copyright_sli">
                    <p className="copyright_sli_bot">Solution Logique Informatique © 2022</p>
                </div>
            </div>
        </footer>
    );
