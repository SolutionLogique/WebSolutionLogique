...
function LogicielsEbp() {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="card-grid">
                        <div
                            ...
                            style={{
                                backgroundImage: "url(/assets/comptabilité.webp)",
                            }}
                        >
                        ...
                        <div
                            ...
                            style={{backgroundImage: "url(/assets/business2.webp)"}}
                        >
                            <div className="overlay">
                                <div className="content">
                        ...
                        <div
                            ...
                            style={{backgroundImage: "url(/assets/bati.webp)"}}
                        >
                            <div className="overlay">
                                <div className="content">
                                    <h2>Batiment</h2>
            ...
            <div className="profile-card">
                <div className="container">
                    <h1 className="heading_logiciels">NOS FORMATIONS</h1>
                    ...
                    <div className="form_formations_sli">
                        <div className="form_formations_sli-start">
                            <div className="en_tete-form">
                                <h2>Tarif de la formation à la ½ journée</h2>
                                <h2>495€</h2>
                            </div>
                            <h3>Nos formations sont accessibles selon ces modalité</h3>
                        ...
                        <div className="formations_place">
                            <div className="formations_block">
                                <h2>où ont lieu nos formations? </h2>
                                <div className="pblock">
                                    <div className="p1">
                                        <FontAwesomeIcon icon={fa1} beat size="xl"/>
                                        <p>
                                            En présentiel, dans les locaux de Solution Logique, adaptés aux personnes à
                                            mobilité réduite.
                                        </p>
                                    </div>
                                    <div className="p2">
                                        <FontAwesomeIcon icon={fa2} beat size="xl"/>
                                        <p>En présentiel, dans les locaux de votre entreprise</p>
                                    </div>
                                    <div className="p3">
                                        <FontAwesomeIcon icon={fa3} beat size="xl"/>
                                        <p>
                    ...
                    >
                      {" "}
                        ISL Online
                            ...
                            <div className="formations_block-left">
                                <h2>
                            ...
                            <div className="formations_block-right">
                            ...
                            <div className="formations_block-left">
                                ...
                                <h3 className='opcos'><i>Les OPCOS</i></h3>
                                <p>
                    ...
                    <h1>Les différents types de formation</h1>
                    <div className="card-grid">
