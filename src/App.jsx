...
import FactureElectronique from "./components/factureElectronique/factureElectronique";
    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/factureElectronique" element={<FactureElectronique/>}></Route>
            </Routes>
            <Footer/>
        </Router>
    );
